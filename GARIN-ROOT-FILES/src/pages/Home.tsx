        ...
        <div className="grid lg:grid-cols-[1fr,300px] gap-8">
            ...
            <section className="bg-gradient-to-br from-green-700 to-blue-700 rounded-lg shadow-xl p-8 text-white">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div className="text-center col-span-2 md:col-span-1">
                  ...
                  <div className="text-white/90">מוסדות לימוד</div>
                </div>
              </div>
            </section>

            {/* Join Us Form */}
            <section id="join-form" className="scroll-mt-24">
              <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-lg shadow-xl p-8">
                <h2 className="text-2xl md:text-3xl font-bold text-green-700 text-center mb-2">הצטרפו אלינו!</h2>
          ...
          <aside className="hidden lg:block" aria-label="מידע נוסף">
            <div className="sticky top-24 space-y-6">
              ...
              {/* Join Us Button */}
              <div className="bg-gradient-to-br from-green-700 to-green-600 rounded-lg shadow-lg p-6 text-white text-center">
                <h3 className="font-bold text-xl mb-3">הצטרפו אלינו!</h3>
                <p className="text-sm mb-4 text-white/90">
                  רוצים להיות חלק מהקהילה?
                </p>
                <a
                  href="#join-form"
                  className="block bg-white text-green-700 px-6 py-3 rounded-lg font-bold hover:bg-green-50 transition shadow-md"
                  onClick={(e) => {
                    e.preventDefault()

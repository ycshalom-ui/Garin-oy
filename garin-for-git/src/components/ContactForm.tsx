...
export default function ContactForm() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
      <h3 className="text-xl font-bold text-green-700 mb-4">השאירו פרטים ונחזור אליכם</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg bg-gray-50 text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              required
              aria-required="true"
            />
          </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-green-700 hover:bg-green-800 disabled:bg-gray-400 text-white font-semibold py-3 px-6 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-green-500"

      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        {isOpen && (
          <div id="mobile-menu" className="lg:hidden pb-4 space-y-2 border-t border-gray-200 pt-4" role="menu">
            ...
            <Link to="/news" className="block py-2 text-gray-700 hover:bg-gray-100 hover:text-green-700 rounded px-2 transition focus:outline-none focus:ring-2 focus:ring-green-500" role="menuitem" onClick={() => setIsOpen(false)}>עדכונים ופרשת השבוע</Link>

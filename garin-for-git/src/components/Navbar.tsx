      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center gap-6" role="menubar">
            ...
            <Link 
              to="/admin" 
              className="bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 transition focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-md"
              role="menuitem"
            >
              🔐 התחבר
            </Link>
        ...
        <>
          ...
          >
            ...
            <div className="p-4 space-y-2 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 140px)' }}>
              ...
              <Link 
                to="/admin" 
                className="flex items-center gap-3 py-3 px-4 bg-blue-600 text-white hover:bg-blue-700 rounded-lg transition font-semibold mt-4 shadow-lg"
                role="menuitem"
                onClick={() => setIsOpen(false)}
              >
                <span className="text-xl">🔐</span>

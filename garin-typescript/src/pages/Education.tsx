        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mb-20">
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3381.9!2d34.8551!3d32.0226!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzLCsDAxJzIxLjQiTiAzNMKwNTEnMTguNCJF!5e0!3m2!1siw!2sil!4v3"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div>
            ...
            <div className="rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3381.8!2d34.8545!3d32.0230!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzLCsDAxJzIyLjgiTiAzNMKwNTEnMTYuMiJF!5e0!3m2!1siw!2sil!4v4"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="בית ספר סעדיה גאון - משה הדדי 9, אור יהודה"
              ></iframe>
            </div>
            <p className="text-center text-gray-600 mt-4 font-bold">

      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex gap-8">
            ...
            <Link to="/torah" className="hover:text-green-community transition">תורה</Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 flex flex-col gap-4">
            ...
            <Link to="/torah" onClick={() => setIsOpen(false)} className="hover:text-green-community transition">תורה</Link>

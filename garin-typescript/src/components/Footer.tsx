...
export default function Footer() {
  return (
    <footer className="bg-blue-professional text-white">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-white/80">
              ...
              <Link to="/torah" className="hover:text-white transition">תורה ופרשת שבוע</Link>
              ...
              <Link to="/contact" className="hover:text-white transition">צור קשר</Link>
            </div>
          </div>
